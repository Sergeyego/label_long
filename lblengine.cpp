...
void LblEngine::createLblEd(int id_part, QString nam, QString otk, bool barcode)
{
...
{
    QString templ=QString::fromLocal8Bit("SZSM-05");
    ...
    obj.appendChild(newText("4mm","4mm","37mm","29mm",text,7,true,&doc));
    obj.appendChild(newImage("40mm","9mm","26mm","13mm",dir+"/images/simb.png",&doc));
    obj.appendChild(newImage("40mm","25mm","26mm","2.5mm",dir+"/images/site.png",&doc));
    if (!barcode.isEmpty()) {
